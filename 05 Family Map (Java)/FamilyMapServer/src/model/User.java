...
public class User
{
    ...
    {
        String userName = Handler.getBodyPart(userJsonObject, "userName");
        String password = Handler.getBodyPart(userJsonObject, "password");
        String email = Handler.getBodyPart(userJsonObject, "email");
