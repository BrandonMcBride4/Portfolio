...
public class Event implements Serializable
{
    ...
    {
        String eventID = JsonConverter.getMandatoryBodyPart(eventJSON, "eventID");
        String descendant = JsonConverter.getMandatoryBodyPart(eventJSON, "descendant");
        String personID = JsonConverter.getMandatoryBodyPart(eventJSON, "personID");
        double latitude = Double.parseDouble(JsonConverter.getMandatoryBodyPart(eventJSON, "latitude"));
        double longitude = Double.parseDouble(JsonConverter.getMandatoryBodyPart(eventJSON, "longitude"));
        String country = JsonConverter.getMandatoryBodyPart(eventJSON, "country");
        String city = JsonConverter.getMandatoryBodyPart(eventJSON, "city");
        String eventType = JsonConverter.getMandatoryBodyPart(eventJSON, "eventType");
        int year = Integer.parseInt(JsonConverter.getMandatoryBodyPart(eventJSON, "year"));
    ...
    public String eventStringFormat()
    {
        return String.format("%s: %s, %s, (%d)",
                             WordUtils.capitalizeFully(eventType), city, country, year);
    }
